...
public class JourneyActivity extends AppCompatActivity implements LocationListener, GpsStatus.Listener {
    ...
    public void onFabClick(View v) {
        if (!data.isRunning()) {
            fab.setImageDrawable(getResources().getDrawable(R.drawable.ic_baseline_play_arrow_24));
            ...
            fab.setImageDrawable(getResources().getDrawable(R.drawable.ic_baseline_pause_24));
